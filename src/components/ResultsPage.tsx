        ...
        <div className="quiz-alignment-container" style={{ textAlign: textAlignment as any }}>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            <div className="bg-white p-5 rounded-lg border border-gray-200 text-center">
              ...
              <p className={`text-lg font-medium ${performance.color}`}>
                ...
                <span className="sr-only">{Math.round(percentage)} percent</span>
              </p>
              <div 
                ...
                aria-valuemin={0}
                aria-valuemax={100}
                aria-label={`Overall score: ${Math.round(percentage)} percent`}
              >
                <div 
            ...
            <div className="bg-white p-5 rounded-lg border border-gray-200 text-center">
              ...
              <p className="text-2xl font-bold" aria-label={`Total time: ${formatTime(totalTime)}`}>
              ...
              {Object.entries(categoryResults).map(([category, { correct, total, percentage }]) => (
                <div key={category}>
                  <div className="flex justify-between mb-1">
                    ...
                    <span className="text-gray-600" aria-label={`${correct} correct out of ${total}, ${Math.round(percentage)} percent`}>
                  ...
                  <div 
                    ...
                    aria-valuemin={0}
                    aria-valuemax={100}
                    aria-label={`${category}: ${Math.round(percentage)} percent`}
                  >
                    <div 
          ...
          <div className="mb-8 print:break-before-page">
            ...
            <div className="bg-blue-50 border-l-4 border-quiz-primary p-4">
              <ul className="space-y-2" aria-label="Study recommendations">
          ...
          <div className="flex flex-col sm:flex-row justify-center space-y-3 sm:space-y-0 sm:space-x-4 print:hidden">
            <Button 
              onClick={onRestart}
              className="quiz-button-secondary flex items-center justify-center"
            >
              <svg 
